...
class Parser {
  ...
  static void ParseFree(void *p,                 /* The parser to be deleted */
                        void (*freeProc)(void *) /* Function used to reclaim
                                                    memory */
                        );
  static void Parse(void *yyp,    /* The parser */
 ...
 public:
  ...
  bool is_failure() { return state_.failure || state_.errors > 0; }
  void set_lineno(int n) { state_.lineno = n; }
  SharedPtr<Node> root_node() { return this->state_.root_node; }
};
};
