...
void PP_OP_BITOR();
void PP_OP_BITXOR();
void PP_OP_BITLSHIFT();
void PP_OP_BITRSHIFT();
void PP_OP_MOD();
...
void PP_OP_RETURN();
void PP_OP_ENTER();
void PP_OP_ENTER_WHILE();
void PP_OP_ENTER_FOR();
void PP_OP_LEAVE();
void PP_OP_PUSH_IDENTIFIER();
void PP_OP_DUMP();
void PP_OP_JUMP_IF_FALSE();
void PP_OP_JUMP_IF_TRUE();
void PP_OP_JUMP();
void PP_OP_EQ();
void PP_OP_NE();
void PP_OP_GT();
...
void PP_OP_PRE_INCREMENT();
void PP_OP_POST_INCREMENT();
void PP_OP_PRE_DECREMENT();
void PP_OP_POST_DECREMENT();
void PP_OP_FILE_TEST();
...
void PP_OP_CLASS_ENTER();
void PP_OP_CLASS_LEAVE();
void PP_OP_DEREF();
void PP_OP_EXTRACT_ARRAY();
void PP_OP_SET_PACKAGE_VARIABLE();
void PP_OP_INSTANCIATE_IDENTIFIER();
void PP_OP_GET_PACKAGE_VARIABLE();
void PP_OP_LOCAL();
void PP_OP_SET_PARENT();
